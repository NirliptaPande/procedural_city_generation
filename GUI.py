...
class GUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.ui.building_generation_Run.clicked.connect(
            self.start_building_generation)
    ...
    def createTable(self, submodule):
        ...
        def save_params():
            ...
            jsonFromParams(
                os.getcwd() + "/procedural_city_generation/inputs/" + submodule + ".conf", params)
    ...
    def plot(self, x, y, linewidth=1, color="red"):
        self.active_widget.canvas.ax.plot(
            x, y, linewidth=linewidth, color=color)
    ...
    def clean_directories(self):
        ...
        os.system("rm -f " + os.getcwd() +
                  "/procedural_city_generation/outputs/*")
        print(UI.donemessage)
